...
ActiveRecord::Schema[7.0].define(version: 0) do
  ...
  add_foreign_key "assignment", "user", name: "assignment_user_id_foreign"
  ...
  add_foreign_key "canned_response", "user", name: "canned_response_user_id_foreign"
  ...
  add_foreign_key "message", "user", name: "message_user_id_foreign"
  ...
  add_foreign_key "user_cell", "user", name: "user_cell_user_id_foreign"
  add_foreign_key "user_organization", "organization", name: "user_organization_organization_id_foreign"
  add_foreign_key "user_organization", "user", name: "user_organization_user_id_foreign"
end
